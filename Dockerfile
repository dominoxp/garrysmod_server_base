...
RUN mkdir -p "${GMODDIR}" "${CSS}" "${GMODDIR}/garrysmod/addons" "${GMODDIR}/garrysmod/data" "${GMODDIR}/garrysmod/cache" "${GMODDIR}/steam_cache" && \
...
VOLUME ["${GMODDIR}/garrysmod/addons", "${GMODDIR}/garrysmod/data", "${GMODDIR}/garrysmod/cache", "${GMODDIR}/steam_cache"]
